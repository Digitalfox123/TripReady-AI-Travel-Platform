// Generated from Supabase backend database (4,290 real cities across 255 countries)
export const backendCities = {
  "Yemen": [
    "'Ataq",
    "Abyan",
    "Al Bayda'",
    ...
    "Lahij",
    "Ma'rib",
    "Other Yemen (Note: Most currently unsafe for travel)",
    "Sa'dah",
    "San'a'",
    "Sana'a",
    "Ta'izz"
...
export function getBackendCities(countryName) {
  if (!countryName) return [];
  const trimmed = countryName.trim();
  if (backendCities[trimmed]) return backendCities[trimmed];
  const lower = trimmed.toLowerCase();
  const matchedKey = Object.keys(backendCities).find(k => k.toLowerCase() === lower);
  return matchedKey ? backendCities[matchedKey] : [];
}
